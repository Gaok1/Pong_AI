...
use neural_network::{network_drawer::NetworkDrawer, neural_network_f::NeuralNetwork, neuron::ActivationFunction};

const GAMES: i32 = 1200;
const GAMES_DRAWN: i32 = 50;
...
async fn main() {
    ...
    loop {
        ...
        if finished_count as i32 >= GAMES {
